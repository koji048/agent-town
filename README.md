...
(CC0) and characters from the
[KayKit Adventurers pack](https://github.com/KayKit-Game-Assets/KayKit-Character-Pack-Adventures-1.0)
(CC0 by Kay Lousberg), both loaded at runtime from `assets/models/`.
Textures and the map are generated by `tools/generate_assets.py`.
