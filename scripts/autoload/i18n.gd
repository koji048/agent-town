...
const S := {
	...
	"build_hint": {"en": "BUILD: pick from the catalog or click a piece · R rotate · X delete · click to set down · Esc cancel", "th": "จัดห้อง: เลือกของจากแคตตาล็อก หรือคลิกของที่มีอยู่ · R หมุน · X ลบ · คลิกวาง · Esc ยกเลิก"},
	"build_catalog": {"en": "CATALOG", "th": "แคตตาล็อก"},
	"build_keys": {"en": "R rotate · X delete · click place · floors: pick style then click tiles · Esc cancel", "th": "R หมุน · X ลบ · คลิกวาง · พื้น: เลือกลายแล้วคลิกกระเบื้องทีละช่อง · Esc ยกเลิก"},
	"cat_seat": {"en": "Seating", "th": "ที่นั่ง"},
	"cat_store": {"en": "Storage", "th": "เก็บของ"},
	"cat_plant": {"en": "Plants", "th": "ต้นไม้"},
	"cat_rug": {"en": "Rugs", "th": "พรม"},
	"cat_gear": {"en": "Gadgets", "th": "ของใช้"},
	...
	"review_stats": {"en": "%d chars — press the button to read it all", "th": "ยาว %d ตัวอักษร — อ่านเต็มกดปุ่ม 'เปิดไฟล์เต็ม'"},
	"clip_opt_title": {"en": "Clip '%s' — what should the team do?", "th": "คลิป '%s' — ให้ทีมทำอะไรบ้าง?"},
