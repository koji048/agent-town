...
const S := {
	...
	"btn_burn_default": {"en": "✓ Burn — skill standard", "th": "✓ Burn สไตล์มาตรฐาน"},
	"btn_burn_custom": {"en": "🔥 Burn — this style", "th": "🔥 Burn สไตล์ที่เลือก"},
	"studio_auto": {"en": "No touch: burns the standard style in %d s", "th": "ไม่กดอะไร จะ burn สไตล์มาตรฐานเองใน %d วิ"},
